...
我從繁星放榜 2019/3 開始學日文的，直到通過 N1 是考 2022/12 的場次，經歷時長大約三年半，想寫心得想很久了，現在又被問到，想說我就認真寫一次，以後再被問到我就直接貼這篇的連結。

我會著重在一些很偏門的撇步，一些我有做但一般人可能沒想到，讓我學起來效率很不錯的事。
...
有個說法是學習語言要 both input and output，接龍是最簡單的 output 的方法，算是銜接到練口說之前的一個 gateway drug (X)，讓你習慣從腦袋中挖出已知的單字，不用太久，算是經歷過一個幼稚園/小學生的時期的感覺就好，累積一些單字量之後就可以開始。
