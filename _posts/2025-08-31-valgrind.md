...
<div class="toggle-header">gcc -g -o leak leak.c<br>valgrind --leak-check=full ./leak</div>
<div class="toggle-content" style="overflow: hidden; transition: max-height 0.28s; max-height: none;">
        ...
        <div class="highlight">
            <code>
                <table class="rouge-table"><tbody><tr><td class="rouge-gutter gl">
                    <pre class="lineno">1</pre></td><td class="rouge-code"><pre>Hiding Content</pre></td></tr>
                </tbody></table>
            </code>
        </div>
        </div>
