...
DPDK 是個主要以 C 語言寫成的開源套件，全名 Data Plane Development Kit，主要用來高效的處理網路封包相關任務，目標是繞過 OS kernel 的網路協議棧，全部的處理都在用戶端用最有效率的方式完成。
...
DPDK 有幾個核心元素，包含 `rte_ring`, `rte_mempool`, `mbuf`, ... (未寫完，會慢慢補齊)
...
- https://doc.dpdk.org/guides-25.07/testpmd_app_ug/intro.html
- https://doc.dpdk.org/guides-25.07/testpmd_app_ug/build_app.html
- https://doc.dpdk.org/guides-25.07/testpmd_app_ug/run_app.html (太多參數了，要用到再回來找)
- https://doc.dpdk.org/guides-25.07/sample_app_ug/hello_world.html
- https://doc.dpdk.org/guides-25.07/prog_guide/intro.html
...
- 進行 L2 - L4 常見網路協議進行處理
    - 解析 MAC﹑IPV4﹑UDP & TCP port 以及 content
